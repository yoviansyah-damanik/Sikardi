...
class Select extends Component
{
    ...
    public function __construct(
        ...
        $this->baseClass = join(' ', [
            'relative w-full appearance-none border outline-none dark:border-gray-700 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none dark:bg-slate-800 dark:text-gray-100',
            $block ? 'block w-full' : 'min-w-16 sm:max-w-64',
    ...
    {
        $colorVariants = [
            'primary' => 'bg-white focus:border-scampi-700 dark:focus:border-scampi-500',
