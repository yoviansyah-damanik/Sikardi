...
class Radio extends Component
{
    ...
    public function __construct(
        ...
        $this->baseClass = join(
            ...
            [
                'size-4',
                'aspect-square accent-scampi-500 focus:accent-scampi-900 transition duration-150 disabled:bg-slate-50 disabled:text-slate-100 disabled:border-slate-200 disabled:shadow-none',
                $base
            ]
        );
